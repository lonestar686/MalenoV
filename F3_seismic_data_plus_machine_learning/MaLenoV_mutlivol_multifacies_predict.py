...
def segy_decomp(segy_file, plot_data = False, read_direc='xline', inp_res = np.float64):
    ...
    with segyio.open(segy_file, "r" ) as segyfile:
        ...
        # for qc
        print(" ils={}, ile={}, ili={}\n".format(output.inl_start, output.inl_end, output.inl_step))
        print(" xls={}, xle={}, xli={}\n".format(output.xl_start, output.xl_end, output.xl_step))
...
pred_dict = {
    ...
    'xline' : 600, #123900,    # xline used for classification (index)(should be within section range)
