...
pred_dict = {
    'keras_model' :  None, #keras.models.load_model('hei_wells_near_mid_far_ufar_35i_12e_10000.h5'), # input model to be used for prediction, to load a model use: keras.models.load_model('write_location')
    'section_edge' : np.asarray([32372, 37020, 124324, 124324, 1000, 2900]), # inline and xline section to be predicted (all depths), must contain xline
    ...
    'save_location' : 'hei_wells_fullstack_45i_14e_10000_xl124324.segy',     # file name for the saved prediction
